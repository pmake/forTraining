<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="homes.aspx.cs" Inherits="webapp.Forms.app.homes" %>
                    ...
                    <dx:SplitterPane Size="100%">
                        <Panes>
                            <dx:SplitterPane MaxSize="400px" ShowCollapseBackwardButton="True" ShowCollapseForwardButton="False" Size="250px">
                                ...
                                <ContentCollection>
                                    <dx:SplitterContentControl runat="server">
                                        <dx:ASPxTreeView ID="tv_prg" runat="server" AllowSelectNode="True" BackColor="#CCCCCC" EnableCallBacks="True" OnNodeClick="tv_prg_NodeClick" Theme="Metropolis" Width="100%">
                                        </dx:ASPxTreeView>
                                    </dx:SplitterContentControl>
                                </ContentCollection>
                            </dx:SplitterPane>
