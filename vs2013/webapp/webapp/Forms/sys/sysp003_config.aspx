                        ...
                        <div>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxCheckBox ID="cbx_prg_icon" runat="server" CheckState="Unchecked" Font-Size="Medium" Theme="BlackGlass">
                                        </dx:ASPxCheckBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxCheckBox ID="cbx_multi_language" runat="server" CheckState="Unchecked" Font-Size="Medium" Theme="BlackGlass">
                                        </dx:ASPxCheckBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxCheckBox ID="cbx_multi_company" runat="server" CheckState="Unchecked" Font-Size="Medium" Theme="BlackGlass">
                                        </dx:ASPxCheckBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxCheckBox ID="cbx_user_company" runat="server" CheckState="Unchecked" Font-Size="Medium" Theme="BlackGlass">
                                        </dx:ASPxCheckBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxTextBox ID="txt_admin_url" runat="server" Font-Size="Medium" Theme="BlackGlass" Width="300px">
                                        </dx:ASPxTextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxTextBox ID="txt_languages" runat="server" Font-Size="Medium" Theme="BlackGlass" Width="300px">
                                        </dx:ASPxTextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="cbb_font_size" runat="server" EnableTheming="True" Font-Size="Medium" SelectedIndex="0" Theme="BlackGlass" Width="300px">
                                            <Items>
