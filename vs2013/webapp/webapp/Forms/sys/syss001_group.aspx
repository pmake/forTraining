<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="syss001_group.aspx.cs" Inherits="webapp.Forms.sys.syss001_group" %>
            ...
            <dx:ASPxRoundPanel ID="rpl_master" runat="server" OnInit="rpl_master_Init" ShowCollapseButton="true" Theme="BlackGlass" Width="100%">
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_sys_group" EnableTheming="True" KeyFieldName="rowid" OnInit="gv_master_Init" OnInitNewRow="gv_master_InitNewRow" OnRowValidating="gv_master_RowValidating" Theme="BlackGlass" Width="100%">
