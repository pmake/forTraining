            ...
            <dx:ASPxRoundPanel ID="rpl_master" runat="server" OnInit="rpl_master_Init" Theme="BlackGlass" Width="100%">
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_sys_module" EnableTheming="True" KeyFieldName="rowid" OnInit="gv_master_Init" Theme="BlackGlass" Width="100%" OnInitNewRow="gv_master_InitNewRow" OnRowValidating="gv_master_RowValidating">
