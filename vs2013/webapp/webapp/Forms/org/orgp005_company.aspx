...
<dx:PanelContent runat="server">
    <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_org_company" EnableTheming="True" KeyFieldName="rowid" OnInit="gv_master_Init" OnInitNewRow="gv_master_InitNewRow" OnRowValidating="gv_master_RowValidating" Theme="BlackGlass" Width="100%">
        ...
        <div>
            <asp:SqlDataSource ID="sds_z_org_company" runat="server" ConnectionString="<%$ ConnectionStrings:dbconn %>" DeleteCommand="DELETE FROM [z_org_company] WHERE [rowid] = @rowid" InsertCommand="INSERT INTO [z_org_company] ([isenabled], [no_comp], [name_comp], [id_comp], [name_boss], [tel_comp], [fax_comp], [email_comp], [addr_comp], [remark]) VALUES (@isenabled, @no_comp, @name_comp, @id_comp, @name_boss, @tel_comp, @fax_comp, @email_comp, @addr_comp, @remark)" OnInit="sds_z_org_company_Init" SelectCommand="SELECT no_comp, name_comp, isenabled, id_comp, name_boss, tel_comp, fax_comp, email_comp, addr_comp, remark, rowid FROM z_org_company ORDER BY no_comp" UpdateCommand="UPDATE [z_org_company] SET [isenabled] = @isenabled, [no_comp] = @no_comp, [name_comp] = @name_comp, [id_comp] = @id_comp, [name_boss] = @name_boss, [tel_comp] = @tel_comp, [fax_comp] = @fax_comp, [email_comp] = @email_comp, [addr_comp] = @addr_comp, [remark] = @remark WHERE [rowid] = @rowid">
                <DeleteParameters>
