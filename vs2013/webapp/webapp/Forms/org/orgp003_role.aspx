            ...
            <dx:ASPxRoundPanel ID="rpl_master" runat="server" OnInit="rpl_master_Init" Theme="BlackGlass" Width="100%">
                <PanelCollection>
                    <dx:PanelContent ID="PanelContent1" runat="server">
                        <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" EnableTheming="True" OnInit="gv_master_Init" Theme="BlackGlass" Width="100%" DataSourceID="sds_z_org_role" KeyFieldName="rowid" OnInitNewRow="gv_master_InitNewRow" OnRowValidating="gv_master_RowValidating">
                            <SettingsDetail ShowDetailRow="True" />
                            <Templates>
                                <DetailRow>
                                    <dx:ASPxGridView ID="gv_detail" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_org_role_user" EnableTheming="True" KeyFieldName="rowid" OnBeforePerformDataSelect="gv_detail_BeforePerformDataSelect" OnInit="gv_detail_Init" OnInitNewRow="gv_detail_InitNewRow" Theme="BlackGlass" Width="100%" OnRowValidating="gv_detail_RowValidating">
