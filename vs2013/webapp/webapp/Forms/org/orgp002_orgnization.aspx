            ...
            <dx:ASPxRoundPanel ID="rpl_master" runat="server" OnInit="rpl_master_Init" Theme="BlackGlass" Width="100%">
                <PanelCollection>
                    <dx:PanelContent runat="server">
                        <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" EnableTheming="True" OnInit="gv_master_Init" Theme="BlackGlass" Width="100%" DataSourceID="sds_z_org_orgnization1" KeyFieldName="rowid" OnRowValidating="gv_master_RowValidating">
                            <SettingsDetail ShowDetailRow="True" />
                            <Templates>
                                <DetailRow>
                                    <dx:ASPxGridView ID="gv_detail2" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_org_orgnization2" EnableTheming="True" KeyFieldName="rowid" OnBeforePerformDataSelect="gv_detail2_BeforePerformDataSelect" OnInit="gv_detail2_Init" Theme="BlackGlass" Width="100%" OnRowValidating="gv_detail2_RowValidating">
                                        <SettingsDetail ShowDetailRow="True" />
                                        <Templates>
                                            <DetailRow>
