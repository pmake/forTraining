...
<body>
    <form id="form1" runat="server">
                            ...
                            <dx:SplitterContentControl runat="server">
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="width: 34px">
                                            <asp:ImageButton ID="img_home" runat="server" ImageUrl="~/Images/Icons/home32.png" PostBackUrl="~/home.aspx" ToolTip="返回首頁" />
                                        </td>
                                        <td style="width: 34px">
        ...
        <div>
            <asp:SqlDataSource ID="sds_z_sys_module" runat="server" ConnectionString="<%$ ConnectionStrings:dbconn %>" SelectCommand="SELECT [no_module], [name_module] FROM [z_sys_module] WHERE (([isenabled] = @isenabled) AND ([code_module] = @code_module)) ORDER BY [sort_module], [no_module]">
                <SelectParameters>
                    <asp:Parameter DefaultValue="1" Name="isenabled" Type="Int32" />
                    <asp:Parameter DefaultValue="" Name="code_module" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
