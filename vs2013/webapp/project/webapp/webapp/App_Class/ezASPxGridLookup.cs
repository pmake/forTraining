...
namespace ezapp
{
	...
	public static class ezASPxGridLookup
	{
        public static void Init(object sender, EventArgs e)
        {
            ...
            //FontSize
            (sender as ASPxGridLookup).Font.Size = FontUnit.Medium;
            (sender as ASPxGridLookup).GridView.Font.Size = FontUnit.Medium;
            (sender as ASPxGridLookup).GridViewStyles.Table.Font.Size = FontUnit.Medium;
            (sender as ASPxGridLookup).GridViewStyles.Header.Font.Size = FontUnit.Medium;
            (sender as ASPxGridLookup).GridViewStyles.TitlePanel.Font.Size = FontUnit.Medium;
            (sender as ASPxGridLookup).GridViewStylesPager.Pager.Font.Size = FontUnit.Medium;
            //Focus
