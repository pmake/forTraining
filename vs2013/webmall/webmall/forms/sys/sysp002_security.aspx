<%@ Page Title="" Language="C#" MasterPageFile="~/manager.Master" AutoEventWireup="true" CodeBehind="sysp002_security.aspx.cs" Inherits="webmall.Forms.sys.sysp002_security" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <dx:ASPxRoundPanel ID="rpl_master" runat="server" Width="100%" OnInit="rpl_master_Init" Theme="Office2003Olive">
            <PanelCollection>
                <dx:PanelContent runat="server">
                    <div>
                        <table>
                            <tr>
                                <td>
                                    <dx:ASPxButton ID="btn_add" runat="server" Font-Size="Medium" Text="加入程式" Theme="Office2003Olive" OnClick="btn_add_Click">
                                    </dx:ASPxButton>
                                </td>
                                <td>
                                    <dx:ASPxButton ID="btn_copy" runat="server" Font-Size="Medium" Text="權限複製" Theme="Office2003Olive" OnClick="btn_copy_Click">
                                    </dx:ASPxButton>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 400px; vertical-align: top; text-align: left;">
                                    <dx:ASPxPageControl ID="pgc_user" runat="server" ActiveTabIndex="0" OnInit="pgc_user_Init" Width="100%" AutoPostBack="True" OnActiveTabChanged="pgc_user_ActiveTabChanged" Theme="Office2003Olive">
                                        <TabPages>
                                            <dx:TabPage Text="使用者">
                                                <ContentCollection>
                                                    <dx:ContentControl runat="server">
                                                        <div>
                                                            <dx:ASPxComboBox ID="cbb_comp_code" runat="server" EnableTheming="True" Font-Size="Small" SelectedIndex="0" Theme="Office2003Olive" Width="100%">
                                                                <ClientSideEvents ValueChanged="function(s, e) {
	gv_master.PerformCallback(s.GetValue());
}" />
                                                                <Items>
                                                                    <dx:ListEditItem Selected="True" Text="公司使用者" Value="M" />
                                                                    <dx:ListEditItem Text="客戶使用者" Value="C" />
                                                                    <dx:ListEditItem Text="廠商使用者" Value="V" />
                                                                </Items>
                                                            </dx:ASPxComboBox>
                                                        </div>
                                                        <hr />
                                                        <div>
                                                            <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_org_user" EnableCallBacks="False" EnableTheming="True" KeyFieldName="no_user" OnInit="gv_master_Init" OnSelectionChanged="gv_master_SelectionChanged" Theme="Office2003Olive" Width="100%" ClientInstanceName="gv_master" OnCustomCallback="gv_master_CustomCallback">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="名稱" FieldName="name_user" ShowInCustomizationForm="True" VisibleIndex="4" Width="100%">
                                                                        <HeaderStyle Wrap="False" />
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="數量" FieldName="counts" ShowInCustomizationForm="True" VisibleIndex="5">
                                                                        <HeaderStyle Wrap="False" />
                                                                        <CellStyle Wrap="False">
                                                                        </CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="公司" FieldName="comp_sname" ShowInCustomizationForm="True" VisibleIndex="1">
                                                                        <HeaderStyle Wrap="False" />
                                                                        <CellStyle Wrap="False">
                                                                        </CellStyle>
                                                                    </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:TabPage Text="群組">
                                                <ContentCollection>
                                                    <dx:ContentControl runat="server">
                                                        <dx:ASPxGridView ID="gv_group" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_sys_group" EnableCallBacks="False" EnableTheming="True" KeyFieldName="no_group" OnInit="gv_group_Init" OnSelectionChanged="gv_group_SelectionChanged" Theme="Office2003Olive" Width="100%">
                                                            <Settings ShowFilterRow="True" />
                                                            <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                                                            <Columns>
                                                                <dx:GridViewCommandColumn SelectAllCheckboxMode="Page" ShowClearFilterButton="True" ShowInCustomizationForm="True" ShowSelectCheckbox="True" VisibleIndex="0">
                                ...
                                <td style="vertical-align: top; text-align: left;">
                                    <dx:ASPxPageControl ID="pgc_security" runat="server" ActiveTabIndex="0" EnableTheming="True" OnInit="pgc_security_Init" Theme="Office2003Olive" Width="100%">
                                        <TabPages>
                                            <dx:TabPage Text="程式權限">
                                                <ContentCollection>
                                                    <dx:ContentControl runat="server">
                                                        <dx:ASPxGridView ID="gv_detail" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_sys_security" EnableTheming="True" KeyFieldName="rowid" OnInit="gv_detail_Init" Theme="Office2003Olive" Width="100%">
                                                            <Settings ShowFilterRow="True" />
                                            ...
                                            <dx:TabPage Text="權限群組">
                                                <ContentCollection>
                                                    <dx:ContentControl runat="server">
                                                        <dx:ASPxGridView ID="gv_user_group" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_org_user_group" EnableTheming="True" KeyFieldName="rowid" OnInit="gv_user_group_Init" OnInitNewRow="gv_user_group_InitNewRow" Theme="Office2003Olive" Width="100%" OnRowValidating="gv_user_group_RowValidating">
                                                            <Columns>
    ...
    <div>
        <dx:ASPxPopupControl ID="puc_add" runat="server" HeaderText="未加入程式清單" OnInit="puc_add_Init" Theme="Office2003Olive" Width="600px">
            <ContentCollection>
                <dx:PopupControlContentControl runat="server">
                    <div>
                        <table>
                            <tr>
                                <td>
                                    <dx:ASPxButton ID="btn_add_confirm" runat="server" Text="確定加入" Theme="Office2003Olive" Font-Size="Medium" OnClick="btn_add_confirm_Click">
                                    </dx:ASPxButton>
                                </td>
                                <td>
                                    <dx:ASPxButton ID="btn_add_cancel" runat="server" Font-Size="Medium" OnClick="btn_add_cancel_Click" Text="取消關閉" Theme="Office2003Olive">
                                    </dx:ASPxButton>
                                </td>
                            </tr>
                        </table>
                    ...
                    <hr />
                    <div>
                        <dx:ASPxGridView ID="gv_add" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_sys_prg" EnableTheming="True" KeyFieldName="no_prg" OnInit="gv_add_Init" Theme="Office2003Olive" Width="100%">
                            <Settings ShowFilterRow="True" />
                            <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                            <Columns>
    ...
    <div>
        <dx:ASPxPopupControl ID="puc_copy" runat="server" HeaderText="權限複製" Theme="Office2003Olive" Width="600px" OnInit="puc_copy_Init" Height="600px">
            <ContentCollection>
                <dx:PopupControlContentControl runat="server">
                    <div>
                        <table>
                            <tr>
                                <td>
                                    <dx:ASPxButton ID="btn_copy_confirm" runat="server" Font-Size="Medium" OnClick="btn_copy_confirm_Click" Text="確定複製" Theme="Office2003Olive">
                                    </dx:ASPxButton>
                                </td>
                                <td>
                                    <dx:ASPxButton ID="btn_copy_cancel" runat="server" Font-Size="Medium" OnClick="btn_copy_cancel_Click" Text="關閉視窗" Theme="Office2003Olive">
                                    </dx:ASPxButton>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxComboBox ID="cbb_source" runat="server" AutoPostBack="True" DataSourceID="sds_z_org_user" EnableTheming="True" Font-Size="Medium" TextField="name_user" TextFormatString="{0} {1}" Theme="Office2003Olive" ValueField="rowid" Width="100%">
                                        <Columns>
                    ...
                    <div>
                        <dx:ASPxGridView ID="gv_copy" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_org_user_target" EnableTheming="True" KeyFieldName="rowid" OnInit="gv_copy_Init" Theme="Office2003Olive" Width="100%">
                            <Settings ShowFilterRow="True" />
                            <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                            <Columns>
                                <dx:GridViewCommandColumn SelectAllCheckboxMode="AllPages" ShowClearFilterButton="True" ShowInCustomizationForm="True" ShowSelectCheckbox="True" VisibleIndex="0">
    ...
    <div>
        <asp:SqlDataSource ID="sds_z_org_user" runat="server" ConnectionString="<%$ ConnectionStrings:dbconn %>" SelectCommand="SELECT z_org_user_role.name_role AS role_name, z_org_company.sname_comp AS comp_sname, z_org_user.no_user, z_org_user.name_user, (SELECT COUNT(*) AS Expr1 FROM z_sys_security WHERE (user_no = z_org_user.no_user)) AS counts, z_org_user.role_no, z_org_user.rowid FROM z_org_user INNER JOIN z_org_company ON z_org_user.comp_no = z_org_company.no_comp AND z_org_user.comp_code = z_org_company.code_comp LEFT OUTER JOIN z_org_user_role ON z_org_user.role_no = z_org_user_role.no_role WHERE (z_org_user.isenabled = @isenabled) AND (z_org_user.issecurity = @issecurity) AND (z_org_user.comp_code = @comp_code) AND (z_org_company.isenabled = @isenabled) AND (z_org_company.issecurity = @issecurity) ORDER BY z_org_user.no_user" OnInit="sds_z_org_user_Init">
            <SelectParameters>
                <asp:Parameter DefaultValue="1" Name="isenabled" Type="Int32" />
                <asp:Parameter DefaultValue="1" Name="issecurity" />
                <asp:SessionParameter DefaultValue="" Name="comp_code" SessionField="parm4" />
            </SelectParameters>
        </asp:SqlDataSource>
