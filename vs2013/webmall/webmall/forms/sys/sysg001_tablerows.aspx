<%@ Page Title="" Language="C#" MasterPageFile="~/manager.Master" AutoEventWireup="true" CodeBehind="sysg001_tablerows.aspx.cs" Inherits="webmall.Forms.sys.sysg001_tablerows" %>
                ...
                <dx:PanelContent runat="server">
                    ...
                    <div>
                        <table style="width: 1000px">
                            <tr>
                                <td>
                                    <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" DataSourceID="sds_tablerows" Theme="Office2003Olive" Width="100%">
