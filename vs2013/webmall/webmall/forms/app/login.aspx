<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="webmall.forms.app.login" %>
                    ...
                    <PanelCollection>
                        <dx:PanelContent runat="server">
                            <table style="width: 100%">
                                    ...
                                    <td>
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxTextBox ID="txt_user_no" runat="server" Font-Size="Medium" Width="100%" ToolTip="登入帳號不可空白!!" Theme="Office2003Olive">
                                                    </dx:ASPxTextBox>
                                                </td>
                                                <td style="width: 10px">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxTextBox ID="txt_password" runat="server" Font-Size="Medium" Password="True" Width="100%" Theme="Office2003Olive">
                                                    </dx:ASPxTextBox>
                                                </td>
                                                <td style="width: 10px">
                                ...
                                <tr>
                                    <td>
                                        <dx:ASPxCaptcha ID="cpc_code" runat="server" CharacterSet="1234567890" CodeLength="4" Font-Size="Medium" Theme="Office2003Olive">
                                            <TextBoxStyle Font-Size="Medium" Width="200px" />
                                            <RefreshButton Visible="False">
                                            </RefreshButton>
                                            <ChallengeImage Width="140" ForegroundColor="#000000">
                                            </ChallengeImage>
                                        </dx:ASPxCaptcha>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <dx:ASPxButton ID="btn_login" runat="server" Font-Size="Medium" Text="登入" Theme="Office2003Olive" OnClick="btn_login_Click">
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
