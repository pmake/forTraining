<%@ Page Title="" Language="C#" MasterPageFile="~/manager.Master" AutoEventWireup="true" CodeBehind="orgp003_role.aspx.cs" Inherits="webmall.Forms.org.orgp003_role" %>
        ...
        <dx:ASPxRoundPanel ID="rpl_master" runat="server" OnInit="rpl_master_Init" Theme="Office2003Olive" Width="100%">
            <PanelCollection>
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" EnableTheming="True" OnInit="gv_master_Init" Theme="Office2003Olive" Width="100%" DataSourceID="sds_z_org_role" KeyFieldName="rowid" OnInitNewRow="gv_master_InitNewRow" OnRowValidating="gv_master_RowValidating">
                        <SettingsDetail ShowDetailRow="True" />
                        <Templates>
                            <DetailRow>
                                <dx:ASPxGridView ID="gv_detail" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_org_role_user" EnableTheming="True" KeyFieldName="rowid" OnBeforePerformDataSelect="gv_detail_BeforePerformDataSelect" OnInit="gv_detail_Init" OnInitNewRow="gv_detail_InitNewRow" Theme="Office2003Olive" Width="100%" OnRowValidating="gv_detail_RowValidating">
...
<Styles AdaptiveDetailButtonWidth="22"></Styles>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="sds_ddlb_z_org_user" runat="server" ConnectionString="<%$ ConnectionStrings:dbconn %>" SelectCommand="SELECT no_user, name_user FROM z_org_user WHERE (role_no = @role_no) ORDER BY no_user" OnInit="sds_ddlb_z_org_user_Init">
            <SelectParameters>
                <asp:Parameter DefaultValue="User" Name="role_no" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
</asp:Content>
