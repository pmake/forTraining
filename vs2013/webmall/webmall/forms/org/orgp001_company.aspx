<%@ Page Title="" Language="C#" MasterPageFile="~/manager.Master" AutoEventWireup="true" CodeBehind="orgp001_company.aspx.cs" Inherits="webmall.Forms.org.orgp001_company" %>
        ...
        <dx:ASPxRoundPanel ID="rpl_master" runat="server" OnInit="rpl_master_Init" Theme="Office2003Olive" Width="100%">
            <PanelCollection>
                <dx:PanelContent runat="server">
                    <dx:ASPxGridView ID="gv_master" runat="server" AutoGenerateColumns="False" DataSourceID="sds_z_org_company" EnableTheming="True" KeyFieldName="rowid" OnInit="gv_master_Init" OnInitNewRow="gv_master_InitNewRow" Theme="Office2003Olive" Width="100%" OnRowValidating="gv_master_RowValidating">
