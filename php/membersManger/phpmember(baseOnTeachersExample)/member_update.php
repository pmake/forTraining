...
//查詢頁面顯示需要的資料
$qsMemberData = 'select * from memberdata where m_username ="' . $_SESSION['loginMember'] . '";';
                        ...
                        <tr valign="top">
                                ...
                                <form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
                                    ...
                                    <div class="dataDiv">
                                        ...
                                        <p><strong>使用帳號：</strong>
                                            <?php echo $resultAssoc['m_username']; ?></p>
                                        ...
                                        <p>
                                            <strong>真實姓名：</strong>
                                            <input name="m_name" type="text" class="normalinput" id="m_name" value="<?php echo $resultAssoc['m_name']; ?>">
                                            <font color="#FF0000">*</font> 
                                        </p>
                                        <p>
                                            <strong>性　　別：</strong>
                                            <input name="m_sex" type="radio" value="女" <?php if( $resultAssoc['m_sex'] == '女') echo 'checked'; ?>>
                                            女
                                            <input name="m_sex" type="radio" value="男" <?php if( $resultAssoc['m_sex'] == '男') echo 'checked'; ?>>
                                            男 
                                            <font color="#FF0000">*</font>
                                        </p>
                                        ...
                                        <p>
                                            <strong>生　　日</strong>：
                                            <input name="m_birthday" type="text" class="normalinput" id="m_birthday" value="<?php echo $resultAssoc['m_birthday']; ?>">
                                        ...
                                        <p>
                                            <strong>電子郵件</strong>：
                                            <input name="m_email" type="text" class="normalinput" id="m_email" value="<?php echo $resultAssoc['m_email']; ?>">
                                            <font color="#FF0000">*</font> 
                                        </p>
                                        ...
                                        <p>
                                            <strong>個人網頁</strong>：
                                            <input name="m_url" type="text" class="normalinput" id="m_url" value="<?php echo $resultAssoc['m_url']; ?>">
                                            <br>
                                            <span class="smalltext">請以「http://」 為開頭。</span> 
                                        </p>
                                        <p>
                                            <strong>電　　話</strong>：
                                            <input name="m_phone" type="text" class="normalinput" id="m_phone" value="<?php echo $resultAssoc['m_phone']; ?>">
                                        </p>
                                        <p>
                                            <strong>住　　址</strong>：
                                            <input name="m_address" type="text" class="normalinput" id="m_address" value="<?php echo $resultAssoc['m_address']; ?>" size="40">
                                        </p>
                                        <p> <font color="#FF0000">*</font> 表示為必填的欄位</p>
                                    </div>
                                    <hr size="1" />
                                    <p align="center">
                                        <input name="m_id" type="hidden" id="m_id" value="<?php echo $resultAssoc['m_id']; ?>">
                            ...
                            <td width="200">
                                ...
                                <div class="regbox">
                                    ...
                                    <p><strong><?php echo $resultAssoc['m_username'];?></strong> 您好。</p>
