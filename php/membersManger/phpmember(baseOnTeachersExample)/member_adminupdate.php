                        ...
                        <tr valign="top">
                            <td class="tdrline">
                                <form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
                                    <div class="dataDiv">
                                        ...
                                        <p><strong>性　　別：</strong>
                                            <input name="m_sex" type="radio" value="女" >女
                                        ...
                                        <p><strong>個人網頁</strong>：
                                            <input name="m_url" type="text" class="normalinput" id="m_url" value=""><br>
                                    ...
                                    <hr size="1">
                                    <p align="center">
                                        <input name="m_id" type="hidden" id="m_id" value="XXXX">
                            ...
                            <td width="200">
                                ...
                                <div class="regbox">
                                    ...
                                    <p><strong>XXXXX</strong> 您好。</p>
                                    <p>本次登入的時間為：<br>
                                        XXXX
                                    </p>
                                    <p align="center"><a href="">會員中心</a> | <a href="?logout=true">登出系統</a></p>
                                </div>
                                <div class="boxbl"></div>
